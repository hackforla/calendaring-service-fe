...
calendaring-server-fe is a project of Hack for LA. Hack for LA is a brigade of a Code for America that exists to {your mission}. {Project Name} helps {target users} accomplish {goal of project}. The {app/site/thing you're building}'s main features include a front end interface for the backend calendaring-service repo.  We use material-kit-pro for the react components.  MPK is an extension of material-ui: --https://www.creative-tim.com/product/material-kit-pro.  The branch (material-kit-pro) has all of the components.  Please use this branch to explore the compnents and only take what you need.  Don't pull the entire branch  into your local branch as it is too heavy.
