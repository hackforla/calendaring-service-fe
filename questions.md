...
11. The `My Schedule` tab [link](https://www.figma.com/file/kwUcXHYpKMHhuktdElLmmw/Calendaring-Home-Unite-Us-Copy?node-id=855%3A8468) is shown several times in the flow never actually used. Is it necessary to still show it?
